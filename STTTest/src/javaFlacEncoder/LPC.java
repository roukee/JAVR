...
public class LPC {
	...
	/**
	 * Calculate an LPC using the given Auto-correlation data. Static method used since this is
	 * slightly faster than a more strictly object-oriented approach.
	 * @param lpc
	 *            LPC to calculate
	 * @param R
	 ...
	 */
	public static void createAutoCorrelation(long[] R, int[] samples, int count, int start,
			int increment, int maxOrder) {
