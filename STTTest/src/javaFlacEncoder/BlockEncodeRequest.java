...
/**
 * BlockEncodeRequests are used to store a full block and necessary information to encode such
 * block. It is assumed member variables will be accessed directly(for speed considerations). This
 * Class simply gathers all values into a single object, but handles no encoding logic itself.
...
public class BlockEncodeRequest {
	...
	/**
	 * Set all values, preparing this object to be sent to an encoder. Member variable "valid" is
	 * set to false by this call.
	 * @param samples
	 ...
	 * @param skip
	 *            Number of samples to skip between samples(this should be equal to
