...
/**
 * This is a utility class that provides methods to both encode to and decode from the extended
 * version of UTF8 used by the FLAC format. All functions should work with standard UTF8 as well,
 * since this only extends it to handle larger input values.
...
public class UTF8Modified {
	...
	static long[] limits = { oneByteLimit, twoByteLimit, threeByteLimit, fourByteLimit,
			fiveByteLimit, sixByteLimit, sevenByteLimit };
	 ...
	 * @param value
	 *            value to convert to extended UTF8(value must be positive and 36 bits or less in
	 *            size)
