...
/**
 * Implements the Subframe abstract class, providing encoding support for the FLAC Verbatim
 * Subframe.
...
public class Subframe_Verbatim extends Subframe {
	...
	@Override
	public int encodeSamples(int[] samples, int count, int start, int skip, EncodedElement data,
		...
		writePosition++;
		EncodedElement
				.packInt(samples, bitsPerSample, writePosition, start, skip, count, dataArray);
